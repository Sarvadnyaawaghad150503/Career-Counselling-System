...
Label = tk.Label(pathway, text="PARAMEDICAL COURSES", font=('Arial', 25))
...
Fact = """Paramedical courses refer to a range of undergraduate and postgraduate programs in the field of healthcare that are aimed at providing support services to medical professionals. These courses are designed to train students in various healthcare-related skills and techniques that are essential for patient care."""
